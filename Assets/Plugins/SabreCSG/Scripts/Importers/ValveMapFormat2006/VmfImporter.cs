                    ...
                    if (closures[0] == "entity" && closures[1] == null)
                    {
                        ...
                        if (TryParsekeyValue(line, out key, out value))
                        {
                            switch (key)
                            {
                                ...
                                case "origin": entity.Origin = entity.GetVector((string)value, true); break;
                                //case "pitch": entity.Pitch = (string)value; break; //CAST EX
                                case "angles": entity.Angles = entity.GetVector((string)value, true); break;
